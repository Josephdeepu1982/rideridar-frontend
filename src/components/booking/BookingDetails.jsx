              ...
              <div className="form-row">
                ...
                <div className="checkbox-group">
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <label htmlFor="gatePickup">Gate Pickup / Meet & Greet</label>
                </div>
              </div>
            </div>
          </>
                ...
                <div className="modal-content">
                  ...
                  <ul>
                    <li>
                      ...
                      <br />- Cancellations within 24 hours result in forfeiture
                      of deposit. Full refund if cancelled more than 24 hours
                      before pickup.
                    </li>

                    <li>
                      <strong>Airport Pickup Policy:</strong>
                      <br />- Driver will wait up to 60 minutes after actual
                      landing time. Additional waiting: SGD 20 per 30 minutes.
                    </li>

                    <li>
                      <strong>Meet & Greet Service:</strong>
                      <br />- Available for SGD 30 extra. Driver meets at
                      arrival gate with a name sign.
                    </li>

                    <li>
                      <strong>Luggage Policy:</strong>
                      <br />- Each vehicle has a specified luggage capacity.
                      Extra luggage may incur additional charges.
                    </li>

                    <li>
                      <strong>Payment:</strong>
                      <br />- Remaining balance must be paid before journey
                      start. Accepted: Cash, PayNow, Bank Transfer.
                    </li>

                    <li>
                      <strong>Liability:</strong>
                      <br />
                      -Ridevanta is not liable for delays due to traffic,
                      weather, or unforeseen events.
                    </li>
                  </ul>
                  <button onClick={closeTermsModal} className="modal-close">
                    Close
                  </button>
                </div>
              </div>
