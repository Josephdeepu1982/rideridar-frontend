...
import "../../assets/css/booking/BookingReview.css";
...
const BookingReview = () => {
    ...
    return (
        <div className="booking-review-outer">
            <div className="booking-review-container">
                ...
                <div className="review-section">
                    ...
                    <p>
                        ...
                        {booking.tripData?.pickupLocation}
                    </p>
                ...
                {booking.flight && (
                    <div className="review-section">
                        ...
                        <p>
                            ...
                            {booking.flight.luggageNumber}
                        </p>
                        <p>
                            <strong>Gate Pickup:</strong>{" "}
                            {booking.flight.isGatePickupRequested
                                ? "Yes"
                                : "No"}
                        </p>
                    </div>
